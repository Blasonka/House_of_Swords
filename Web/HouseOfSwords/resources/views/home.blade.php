...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="card m-5 col-6 col-md-4 col-lg-3 mx-auto text-center bg-dark text-light" style="width: 18rem;">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="/" class="btn btn-secondary disabled mt-auto">Elolvasom</a>
                </div>
            </div>
            ...
            <div class="card m-5 col-6 col-md-4 col-lg-3 mx-auto text-center bg-dark text-light" style="width: 18rem;">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="/cards/developers" class="btn btn-secondary mt-auto">Elolvasom</a>
                </div>
            </div>
